...
describe('Test verify function', () => {
    ...
    test('Testing correct (characters set comparison):', () => {
        ...
        expect(characters).toStrictEqual('ａ ｂ ｃ ｄ 『e』 ｆ ｇ ｈ ｉ ｊ ｋ ｌ ｍ ｎ ｏ ｐ ｑ ｒ ｓ ｔ ｕ ｖ ｗ ｘ ｙ ｚ'.split(' '));
    });    
    ...
    test('Testing regular incorrect, also tests for correct 【s】 placement:', () => {
        ...
        expect(characters).toStrictEqual('ａ ｂ ｃ ｄ 【e】 ｆ ｇ ｈ ｉ ｊ ｋ ｌ ｍ ｎ ｏ ｐ ｑ ｒ 【s】 ｔ ｕ ｖ ｗ ｘ ｙ ｚ'.split(' '));
    });     
    ...
    test('Testing regular incorrect (all wrong characters):', () => {
        ...
        expect(characters).toStrictEqual('ａ ｂ ｃ ｄ ｅ ｆ ｇ ｈ ｉ ｊ ｋ ｌ ｍ ｎ ｏ ｐ ｑ ｒ ｓ ｔ ｕ ｖ ｗ ｘ ｙ ｚ'.split(' '));
    });    
    ...
    test('Testing correct change of character set from correct to wrong:', () => {
        ...
        expect(characters).toStrictEqual('『a』 ｂ ｃ ｄ ｅ ｆ ｇ ｈ ｉ ｊ ｋ ｌ ｍ ｎ ｏ ｐ ｑ ｒ 【s】 ｔ ｕ ｖ ｗ ｘ ｙ ｚ'.split(' '));
    });    
});